...
![Welyne HR AI Agent — pipeline (A0–A9)](.github/pipeline.png)

> Diagram source: [`.github/pipeline.mmd`](.github/pipeline.mmd) (Mermaid). Re-render with `mmdc -i .github/pipeline.mmd -o .github/pipeline.png`.
