...
/**
 * Dot-matrix reveal canvas (three.js shader) — the cinematic backdrop for the
 * login flow. Forward mode reveals dots from the center outward; reverse mode
 * collapses them toward the edges (used on successful sign-in).
 */
...
const ShaderMaterial = ({ source, uniforms }: { source: string; uniforms: Uniforms }) => {
  ...
  const material = useMemo(() => {
    ...
    return new THREE.ShaderMaterial({
      ...
      uniforms: preparedUniforms as THREE.ShaderMaterial["uniforms"],
