...
import { mockAttention } from "@/lib/mocks/data";
import { cn } from "@/lib/utils";

export const metadata = { title: "Needs attention · Welyne HR" };

export default function AttentionPage() {
  const open = mockAttention.filter((a) => a.status === "open");
  const resolved = mockAttention.filter((a) => a.status === "resolved");
    ...
    <>
      ...
      <section className="mb-12">
        ...
        <p className="text-muted-foreground mt-3 text-xs">
          Actions are disabled — resolution endpoints land with the orchestrator
          API in sprint 3.
        </p>
      </section>
